...
public class SecurityConfig {
    ...
    // New method to generate code verifier and challenge
    @Bean
    public String[] generateCodeVerifierAndChallenge() {
    ...
    private String generateCodeVerifier() {
        ...
        return Base64.getUrlEncoder().withoutPadding().encodeToString(randomBytes); // Base64 URL encode without padding
    }
    ...
    private String generateCodeChallenge(String codeVerifier) {
        try {
            ...
            return Base64.getUrlEncoder().withoutPadding().encodeToString(hash); // Base64 URL encode without padding
        } catch (Exception e) {
